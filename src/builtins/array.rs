...
#[inline(always)]
pub fn array_get(obj: &JSObject, index: usize, ctx: &mut JSContext) -> Option<crate::value::JSValue> {
    if obj.is_array() {
...
pub fn call_callback(
    ...
    call_callback_with_this(ctx, callback, JSValue::undefined(), args)
}

pub fn call_callback_with_this(
    ctx: &mut JSContext,
    callback: JSValue,
    this_value: JSValue,
    args: &[JSValue],
